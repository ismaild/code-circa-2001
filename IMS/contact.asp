...
<%@LANGUAGE="VBSCRIPT"%>
<!--#include virtual="/Connections/ConnIMS.asp" -->
<%
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" mm:layoutgroup="true">
  <tr> 
    ...
    <td width="100%" rowspan="2" valign="top" class="Content"><!-- #BeginEditable "Content" -->
      <p><b>Contact Us</b></p>
      <p>Please feel free to call us at any time or use <b><a href="#" onClick="GP_AdvOpenWindow('/contact.htm','IMP','fullscreen=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes',500,400,'center','ignoreLink','',0,'');return document.MM_returnValue">This</a></b> 
        form for feedback</p>
      <p>Suite 120, Office Towers<BR>
        Overport City<BR>
        Durban<BR>
        South Africa</p>
      <p>P.O Box 70174<BR>
        Overport<BR>
        4067</p>
      <p><b>TEL:</b> +27 31 2080713<BR>
        <b>FAX:</b> +27 31 2077645<BR>
        <b>CELL:</b> +27 82 281 7919<BR>
        <b>Email:</b> <a href="mailto:info@ftr.co.za">info@ftr.co.za</a></p>
      <!-- #EndEditable --></td>
