...
<table width="100%" border="0" cellpadding="0" cellspacing="0" mm:layoutgroup="true">
  <tr> 
    ...
    <td width="100%" rowspan="2" valign="top" class="Content"><!-- #BeginEditable "Content" --> 
      <p><font size="+1"><b><font size="3">Islam Media Player Version 2</font> 
        <img src="Assets/images/IMPlayer.jpg" width="169" height="175" align="right"></b></font></p>
      <ul>
        <li><a href="#" onClick="GP_AdvOpenWindow('recitors.htm','IMP','fullscreen=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes',500,400,'center','ignoreLink','',0,'');return document.MM_returnValue">Full 
          List of Recietors</a></li>
        <li><a href="freesoft.asp">Free Sample</a></li>
        <li><a href="#" onClick="GP_AdvOpenWindow('installimp.htm','IMP','fullscreen=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes',500,400,'center','ignoreLink','',0,'');return document.MM_returnValue">Installation 
          Instructions</a></li>
        <li> <a href="#">Locate a official dealer</a></li>
        <li><a href="#" onClick="GP_AdvOpenWindow('/impprice.htm','IMP','fullscreen=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes',500,400,'center','ignoreLink','',0,'');return document.MM_returnValue">Pricing</a> 
        </li>
      </ul>
      <p><b>What is Islam Media Player ?</b> Islam Media Player is a revamped, 
        much more advanced Software compared to the successful Quraan Player&#133;. 
        Because of the success of Quraan Player and the need and the request for 
        more recitors , Islam Media Player was born. Islam Media Player now allows 
        us that flexibility to cater for different recitators across multiple 
        cds.</p>
      <p></p>
      <b><a href="#" onClick="GP_AdvOpenWindow('order.asp?AID=1','Order','fullscreen=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=no',500,400,'center','ignoreLink','',0,'');return document.MM_returnValue"><img src="Assets/images/Banners/120x120_IMP.gif" width="120" height="120" align="left" border="0"></a>How 
      does Islam Media Player work ?</b> <br>
      Islam Media Player is a piece of software that can control Quraanic recitations 
      from various recitors across multiple of CDS. These CDs are categorized 
      into Volumes. What this means is that you will have one software on your 
      hard drive, and you can play any volume you like by simply selecting the 
      options in Islam Media Player&#133;. 
      <p>These new volumes allow you to customise Islam Media Player according 
        to your needs and lets <b>YOU</b> choose your favourite recitors.<br>
      </p>
      <!-- #EndEditable --></td>
